...
// Acion and Filter Hooks
	add_action('wp_enqueue_scripts', 'salenepal_enqueue');
    add_action('after_setup_theme', 'salenepal_setup_theme');
    add_action('widgets_init', 'salenepal_widgets');
    add_action('after_switch_theme', 'salenepal_activate');
    add_action('admin_menu', 'salenepal_admin_menu');
    add_action('admin_init', 'salenepal_admin_init');
    ...
    if ( !is_front_page() ) {
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            if($post_type != 'post') {
                ...
                echo '<li class="item-cat item-custom-post-type-' . $post_type . '"><a class="bread-cat bread-custom-post-type-' . $post_type . '" href="' . esc_url( $term_link ) . '" title="' . $post_type_object->labels->name . '">' .  $terms[0]->name . '</a></li>';
